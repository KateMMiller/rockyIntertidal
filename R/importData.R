...
importData <- function(type = c('DSN', 'file'), DSN = 'rocky_BE', path = NA, new_env = TRUE){
  ...
  assign("PointIntercept_BoldDist_A", DBI::dbReadTable(db, "qryR_FlatFile_PointIntercept_BoltDist_parta"), envir = env)
  setTxtProgressBar(pb, 7)
  assign("PointIntercept_BoldDist_B", DBI::dbReadTable(db, "qryR_FlatFile_PointIntercept_BoltDist_partb"), envir = env)
  setTxtProgressBar(pb, 8)
  assign("PointIntercept_BoldDist_C", DBI::dbReadTable(db, "qryR_FlatFile_PointIntercept_BoltDist_partc"), envir = env)
