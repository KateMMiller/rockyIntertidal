...
#' minv_BOHA2 <- sumEchinoMeas(location = c("CALISL", "GREISL"))
...
sumEchinoMeas <- function(park = "all", location = "all", plotName = "all",
  ...
  echo <- force(getEchinoMeas(park = park, location = location, plotName = plotName,
  ...
  echo_sum <- echo |> group_by(Site_Name, Site_Code, Loc_Name, Loc_Code, Start_Date, Year,
