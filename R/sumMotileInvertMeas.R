...
sumMotileInvertMeas <- function(park = "all", location = "all", plotName = "all",
  ...
  motinv_sum <- motinv |> group_by(Site_Name, Site_Code, Loc_Name, Loc_Code, Start_Date, Year,
                                   QAQC, Target_Species, Spp_Code, Spp_Name, Measurement) |>
